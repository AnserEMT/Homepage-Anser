...
Anser EMT is an open-source electromagnetic tracking system developed at University College Cork in collaboration with IHU Strasbourg (see [Anser.io](https://anser.io)).
...
|-------|------------------|----------|-----------------------|
|[Qt-Anser](https://github.com/StephenHinds/qt-anser)|PyQT|Windows & MacOS|GUI|
...
TThe main hardware components of the Anser System.

<p align="center">
	<img  width="70%"src="readme/img/Anser Hardware Overview.svg">
</p>

<small>
DDS: Digital Digital Synthesiser, MCU: Micro-Controller, DAQ: Data Acquisition Device
</small>
